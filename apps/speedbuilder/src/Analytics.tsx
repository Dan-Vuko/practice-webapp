...
import { db, SessionEntity, UserPatternProgressEntity } from './database'
  ...
  const loadSessions = async () => {
    try {
      ...
      if (data.success) {
        ...
        setSessions(sessionData.sort((a, b) => new Date(a.start_time).getTime() - new Date(b.start_time).getTime()))
