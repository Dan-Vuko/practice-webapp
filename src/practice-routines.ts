...
export type ExerciseType =
  ...
  | 'warm-up-60'           // Warm-up at 60% tempo
  | 'warm-up-70'           // Warm-up at 70% tempo
  | 'pianissimo'           // Soft volume practice
  | 'sub-baseline-recovery' // Recovery at 35% tempo
  | 'variable-push'        // Variable tempo ±30%
  | 'overspeed-push'       // 110% tempo push
  | 'recovery'             // Recovery phase
  | 'main-workout'         // Main workout phase
  | 'step-progression'     // Step-by-step progression
  | 'rest';                // Rest period
