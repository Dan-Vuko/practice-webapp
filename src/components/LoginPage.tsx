...
export function LoginPage() {
  ...
  const { signInAsAdmin, signInWithGoogle } = useAuth()
        ...
        <div className="bg-slate-800/50 backdrop-blur-sm rounded-2xl p-8 shadow-xl border border-slate-700/50">
          ...
          <div className="mt-6">
            ...
            <button
              ...
              className="mt-4 w-full py-3 px-4 bg-white hover:bg-gray-100 text-gray-800 font-medium rounded-lg transition-colors flex items-center justify-center gap-3"
            >
